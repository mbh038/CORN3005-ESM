...
knitr::include_graphics(here("figures","grizzly1.jpg"))
```
...
```{r}
#| label: fig-life-history
#| echo: false

knitr::include_graphics(here("figures","IM16.jpg"))
```

You can clone the base grizzly bear model [here](https://insightmaker.com/insight/3cyvDTKAvL24DSvdyQSidb). This model has not yet been parameterized!
...
knitr::include_graphics(here("figures","grizzly_table1.jpg"))
```
...
From [Schwartz et al 2006](figures/schwarz_grizzly1.pdf) we know that:
...
knitr::include_graphics(here("figures","grizzly_table2.jpg"))
```
...
Again, you can clone the base grizzly bear model [here](https://insightmaker.com/insight/3cyvDTKAvL24DSvdyQSidb) if you haven't already.
